 ...
 <script type="text/javascript">
       $(document).ready(function() {
            ...
            $("#xoahet").click(function(){
                ...
                if (hoi==true) document.location.href = "set_admin/tieu-chi/khac/multi_delete/" + listid;
            });
      });
</script>
  ...
  <table id="example2" class="table table-bordered table-hover" style="width:100%;">
    <thead>                 
      <tr class="bg-top">
        ...
        <th width="10%" class="text-center">Loại MC</th>
      </tr>
    </thead> 
    <tfoot>
      <tr>
    ...
    @foreach($Tieuchi as $TC)                                  
      <tr>
        ...
        <td align="center">
          <input type="text" value="{{$TC->stt}}" data-val0="{{$TC->id}}" data-val1="ht96_tieuchi_khac"  data_val2="{{$TC->stt}}"  name="ordering[]" class="tipS smallText update_stt" title="Nhập số thứ tự bài viết"  />
          <div id="ajaxloader">
        ...
        <td class="text-center">
          ...
          <a data-val2="ht96_tieuchi_khac" rel="{$TC->hienthi}" data-val3="hienthi" class="checktt diamondToggle <?=$f;?>"  data-val0="{{$TC->id}}"></a>   
        </td>
         <td class="text-center">                                                   
          <a title="Sửa bài viết" href="set_admin/tieu-chi/khac/edit/{{$TC->id}}"><i class="fa fa-2x fa-edit"></i></a>
        </td> 

        <td class="text-center" title="xóa bài viết">
          <a href="set_admin/tieu-chi/khac/one_delete/{{$TC->id}}" onClick="if(!confirm('Xác nhận xóa:')) return false;">
...
<a href="set_admin/tieu-chi/khac/add"><button class=" btn btn-success btn2">Thêm</button></a>
