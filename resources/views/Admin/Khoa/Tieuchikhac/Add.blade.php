...
@section('title',' thêm tiêu chí khác mới')
@section('content') 

<div class="h3 padding20 text-center">Thêm tiêu chí khác mới</div>
...
<form name="" method="post" action="set_admin/tieu-chi/khac/add" enctype="multipart/form-data">
