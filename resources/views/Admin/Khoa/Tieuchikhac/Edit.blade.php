...
@section('title',' cập nhật tiêu chí')
@section('content') 

<div class="h3 padding20 text-center">Cập nhật tiêu chí khác</div>
...
<form  method="post" action="set_admin/tieu-chi/khac/edit/{{$Tieuchi->id}}" enctype="multipart/form-data">
    ...
    <div class="clearfix"></div>
      <div id="content_tabs">               
          <div id="tab1">
			...
			<a href="set_admin/tieu-chi/khac/list"><input type="button" value="Thoát"  class="btn btn-danger btn2" /></a>
	</div>	
</div>
