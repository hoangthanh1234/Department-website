...
<div class="h3 padding20 text-center">Thêm loại bài báo khoa học mới</div>
...
<form name="" method="post" action="set_admin/loaibaibao/add" enctype="multipart/form-data">
