	...
	<table class="table table-bordered table-hover example2">
		...
		<thead>
			<tr class="bg-top">				
				...
				<td class="text-center" width="8%">Hành động</td>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center">
                    ...
                    <a  class="btn btn-link btn-danger xoatohopmoi" data-id="{{$ctxt->id_tohop}}">
				      ...
				      <div class="modal-body">
				        ...
				        <div class="row">
				        	<div class="col-lg-3 col-md-4">
				        		<label>Điểm</label>
				        		<input type="text" class="text-center form-control " value="{{$ctxt->diem}}" id="diemtohop{{$ctxt->id_tohop}}">				        		
				        	</div>				        	
				        </div>
				      </div>
				      <div class="modal-footer">
				        <button type="button" class="btn btn-danger" data-dismiss="modal">Thoát</button>
				        <input type="button" class="btn btn-success btn-tohop" data-id="{{$ctxt->id_tohop}}" value="Lưu">
				      </div>
				    </div>
				  </div>
			</div>
...
<div id="modalthem" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
				    <div class="col-lg-10 col-md-10">
				        <label>Tên tổ hợp:</label>
				        <select class="form-control" id="tohopthem">
				        	@foreach($Tohop as $th)
				    ...
				    <div class="col-lg-2 col-md-2">
				    	<label>Điểm</label>
				    	<input type="text" class="form-control text-center" id="diemthem">
				    </div>			      
				</div>
			</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-danger" data-dismiss="modal">Thoát</button>
				<input type="button" class="btn btn-success" id="luuthemtohop" value="Lưu">
			</div>
		</div>
	</div>
</div>
