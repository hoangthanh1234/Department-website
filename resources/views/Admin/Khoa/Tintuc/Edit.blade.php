...
<form name="" method="post" action="set_admin/tintuc/edit/{{$Tintuc->id}}" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
            <b class="ten2x">Danh mục</b><br>
              <select name="id_cate" class="form-control select2">                
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              ...
              <select name="id_bomon" class="form-control select2">                
                @foreach($Bomon as $DE)
                  <option value="{{$DE->id}}" @if($DE->id==$Tintuc->id_bomon) selected @endif>{{$DE->ten_vi}}</option>
                @endforeach           
              </select>
          </div> 
          <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <b class="ten2x">Loại bài viết</b>  
              <select name="loaibv" class="form-control "> 
