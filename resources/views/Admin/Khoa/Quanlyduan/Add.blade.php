...
@section('title',' thêm thông tin dự án')
@section('content') 

<div class="h3 padding20 text-center">Thêm dự án mới</div>
...
<form name="" method="post" action="set_admin/qlduan/add" enctype="multipart/form-data">
...
<br> 
        ...
        <div id="content_tabs">               
            <div id="tab1">
                  ...
                  <textarea name="noidung_vi" id="tiny">{{old('noidung_vi')}}</textarea>
                  <br/>
            </div> 
            ...
            <div id="tab2">
                 ...
                 <b class="ten2x">Nội dung dự án</b>
                 <textarea name="noidung_en" id="tiny1">{{old('noidung_en')}}</textarea>
                 <br/>
            </div> 
