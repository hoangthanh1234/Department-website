...
<form name="" method="post" action="{{ asset('set_admin/mon/add') }}" enctype="multipart/form-data">
<div class="container-fluid">  
        ...
        <div id="content_tabs">               
            <div id="tab1">
            	<b class="ten2x">Tên môn</b><input type="text" name="ten_vi" value="{{old('ten_vi')}}"  class="form-control" /><br/>
              <b class="ten2x">Mã môn</b><input type="text" name="mamon" value="{{old('mamon')}}"  class="form-control" /><br/>
            ...
            <div id="tab2">
            	 <b class="ten2x">Tên môn</b><input type="text" name="ten_en" value="{{old('ten_en')}}" class="form-control" /><br/>
