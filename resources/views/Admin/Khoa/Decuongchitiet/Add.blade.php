...
<div class="h3 padding20 text-center">Thêm đề cương chi tiết mới</div>
...
<form name="" method="post" action="set_admin/decuongchitiet/add" enctype="multipart/form-data">
    ...
    <div id="tabs"> 
      ...
      <a href="set_admin/decuongchitiet/list/0"><input type="button" value="Thoát"  class="btn btn-danger btn2" /></a>
  </div><!---END #tabs--> 
</div>
