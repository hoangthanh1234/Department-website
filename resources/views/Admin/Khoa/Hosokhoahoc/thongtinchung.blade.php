...
<form  name="" method="post" action="set_admin/{{$Giangvien->tenkhongdau}}/thong-tin-chung/{{$tab}}/{{$Giangvien->id}}" enctype="multipart/form-data">
     <div id="tabs">
        <ul id="ultabs">         
    ...
    <a href="set_admin/giangvien/list/{{$Giangvien->bomon->id}}"><input type="button" value="Thoát"  class="btn btn-danger btn2" /></a>
    </div>
