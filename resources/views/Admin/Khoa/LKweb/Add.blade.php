...
@section('title',' thêm website liên kết mới')
@section('content') 

<div class="h3 padding20 text-center">Thêm website liên kết mới</div>
...
<form name="" method="post" action="set_admin/lkweb/add" enctype="multipart/form-data">
          ...
          <div id="content_tabs">               
            <div id="tab1">
                <b class="ten2x">Tiêu đề</b><input type="text" name="ten_vi" value="{{old('ten_vi')}}"  class="form-control" /><br/>
                 ...
                 <b class="ten2x">Type ("lkweb" hoặc "doitac" )</b><input type="text" name="type" value="{{old('type')}}" class="form-control"/><br/>
            </div> 
