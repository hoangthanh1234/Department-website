...
<table class="table2">
	<tr  style="background:#cccccc;font-weight:bold;">
		...
		<td class="dam boldphieu2" with="55%">Tiêu chuẩn đánh giá</td>
        ...
        <td width="12%" class="text-center dam boldphieu2">Quy đổi giờ NCKH</td>
	</tr>
<!--giảng dạy -->
	<tr>
		<td class="text-center boldphieu1">1</td>
		<td class="boldphieu1" colspan="6">Giảng dạy</td>
	</tr>
...
@foreach($Phieu->phieu_nckh_baibaokhoaduyet as $pbb)
	@if($pbb->id_tieuchi!=$id_tieuchi)
		...
		<tr>
            ...
            <td class="text-center">{{$tong_nckh}}</td>
		</tr>
	@endif
@endforeach
	...
	@if($pdt->id_tieuchi!=$id_tieuchidetai)
		...
		@foreach($Phieu->phieu_nckh_detaikhoaduyet as $pdt2)
			@if($pdt2->id_tieuchi==$pdt->id_tieuchi)
				<?php $soluong=$soluong+1;$tong+=$pdt2->tieuchi->diem;$tong_nckh+=$pdt2->tieuchi->gio;?>
...
<!--tiêu chí khác -->
	<tr>
		...
		<td class="boldphieu1" colspan="6">Tiêu chí khác</td>
	</tr>
	...
	<tr>
		...
		<td class="text-center">{{ $pk->tieuchi->gio}}</td>
...
<tr class="boldphieu1">
	...
	<td>
		<?php $tong_nckh=0;?>
				...
				@endforeach	
        <b>{{round($tong_nckh, 0, PHP_ROUND_HALF_UP)}}</b>
	</td>
</tr>
</table>
