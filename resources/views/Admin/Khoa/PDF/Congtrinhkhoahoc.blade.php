...
<head>
  ...
  <title>AdminSET| DANH SÁCH THỐNG KÊ CÔNG TRÌNH NGHIÊN CỨU KHOA HỌC</title>
...
<p class="text-center dam" style="margin-top:50px;"> DANH SÁCH THỐNG KÊ CÔNG TRÌNH NGHIÊN CỨU KHOA HỌC</p>
...
<table id="table2">
				<tr style="background:#cccccc">
					...
					<td  class="text-center dam">Chủ nhiệm</td>				
					<td  class="text-center dam">Thành viên</td>
					<td  class="text-center dam">Tên công trình</td>									
				...
				@foreach($Detainghiencuu as $dtnc)					
					<tr>
						...
						<td>{{$dtnc->ten_vi}}</td>
						<td class="text-center">{{date('m/Y', strtotime($ctdt->detai->ngaynghiemthu))}}</td>
