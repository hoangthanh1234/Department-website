...
<body>
		...
		<div  style="font-size:16px;padding-top:15px;padding-bottom:10px;font-weight:bold;">II. QUÁ TRÌNH ĐÀO TẠO</div>	
			...
			<div class="row">
				<div class="col-lg-12 pal15">Hệ đào tạo: <b>@if(isset($Daihoc)){{$Daihoc->hedaotao->ten_vi}} @endif</b></div>
			</div>
			<div class="row">
				<div class="col-lg-12 pal15">Nơi đào tạo: <b>@if(isset($Daihoc)) {{$Daihoc->tencoso_vi}} @endif</b></div>
			</div>
			<div class="row">
				<div class="col-lg-12 pal15">Ngành học: <b>@if(isset($Daihoc)) {{$Daihoc->chuyennganh_vi}} @endif</b></div>
			</div>
			<div class="row">
				<div class="col-lg-6 pal15">Nước đào tạo: <b>@if(isset($Daihoc)) {{$Daihoc->noidaotao_vi}} @endif</b></div>
				<div class="col-lg-6-r">Năm tốt nghiệp: <b>@if(isset($Daihoc)) {{date('Y', strtotime($Daihoc->ngayketthuc))}} @endif</b></div>
			</div>

			<div class="row">
				<div class="col-lg-6 pal15">
					Bằng đại học 2: <b>@if(isset($Daihoc)) @if($Daihoc->giangvien->bangdaihoc2!='') {{$Daihoc->giangvien->bangdaihoc2}} @else Không @endif @endif</b>
				</div>
				<div class="col-lg-6-r">
					Năm tốt nghiệp: <b>@if(isset($Daihoc)) {{$Daihoc->giangvien->namtotnghiepbangdaihoc2}} @endif</b>
				</div>
			</div>
			...
			<div class="row">
				...
				@foreach($Giangvien->ngoaingu as $nn)
					<div class="row pal15">
						...
						<div class="col-lg-6-r">Mức độ sử dụng:	<b>{{$nn->thongthao_vi}}</b></div>
					</div>
				@endforeach
...
<div  style="font-size:16px;padding-top:15px;padding-bottom:10px;font-weight:bold;">III. QUÁ TRÌNH CÔNG TÁC CHUYÊN MÔN</div>	
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<td style="text-align:center;" width="60%">Nơi công tác</td>
		...
		<div  style="font-size:16px;padding-top:15px;padding-bottom:10px;font-weight:bold;">IV. QUÁ TRÌNH NGHIÊN CỨU KHOA HỌC</div>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						<td style="text-align:center;" width="7%" class="dam">STT</td>
