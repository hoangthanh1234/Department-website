                  ...
                  <div class="panel-body">                   
                    @foreach($ncv->congvieccbd as $cbd)
                      <div class="well well-lg">
                        <p><a href="set_giangvien/phancongviec/chi-tiet-cong-viec/{{$cbd->id}}">{{$cbd->ten}} &nbsp;&nbsp;({{count($cbd->phancongviecht)}} / {{count($cbd->phancongviec)}})</a></p>
                        <p>
                          ...
                          &nbsp;&nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;
                            ...
                            <a  href="set_giangvien/phancongviec/{{$cbd->giangvien->tenkhongdau}}/{{$cbd->giangvien->id}}.html" style="color:green;">{{$cbd->giangvien->ten}}</a> &nbsp;&nbsp;
                ...
                <div class="panel-heading">Đang tiến hành</div>
                  <div class="panel-body">
                    @foreach($ncv->congviecdth as $dth)
                      <div class="well well-lg">
                        <p><a href="set_giangvien/phancongviec/chi-tiet-cong-viec/{{$dth->id}}">{{$dth->ten}}&nbsp;&nbsp;({{count($dth->phancongviecht)}} / {{count($dth->phancongviec)}})</a></p>
                        <p>
                          ...
                          &nbsp;&nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;
                            {{ \Carbon\Carbon::parse($dth->ngayketthuc)->format('d/m/Y')}}&nbsp;&nbsp;
                             ...
                             <a href="set_giangvien/phancongviec/{{$dth->giangvien->tenkhongdau}}/{{$dth->giangvien->id}}.html" style="color:green;">{{$dth->giangvien->ten}}</a> &nbsp;&nbsp;
                ...
                <div class="panel-heading">Hoàn thành</div>
                  <div class="panel-body">
                    @foreach($ncv->congviecht as $ht)
                      <div class="well well-lg">
                        <p><a href="set_giangvien/phancongviec/chi-tiet-cong-viec/{{$ht->id}}">{{$ht->ten}} &nbsp;&nbsp;({{count($ht->phancongviecht)}} / {{count($ht->phancongviec)}})</a></p>
                        <p>
                          ...
                          &nbsp;&nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;
                            {{ \Carbon\Carbon::parse($ht->ngayketthuc)->format('d/m/Y')}}&nbsp;&nbsp;
                             ...
                             <a href="set_giangvien/phancongviec/{{$ht->giangvien->tenkhongdau}}/{{$ht->giangvien->id}}.html" style="color:green;">{{$ht->giangvien->ten}}</a> &nbsp;&nbsp;
