...
<div class="row">
    ...
    <div class="row">
       ...
       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 top10">
            ...
            <div class="input-group date" data-provide="datepicker">
                <input type="text" name="ngaysinh" class="form-control datepicker"  placeholder="Ngày sinh giảng viên">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 top10">
            <img id="blah" src="#" alt="Ảnh xem trước" style="width:100%;height:200px;" />
        </div> 
    </div> 
