...
<form name="" method="post" action="{{ asset('set_bomon/mon/edit/'.$Moncontent->id) }}" enctype="multipart/form-data">
  ...
  <div id="tabs">  
   ...
   <div id="content_tabs">               
     <div id="tab1">
        ...
        <b class="ten2x">Tên môn <span style="color: red">(*)</span></b><input type="text" name="ten_vi" value="{{$Moncontent->ten_vi}}"  class="form-control" required/><br/><b class="ten2x">Mã môn</b><input type="text" name="mamon" value="{{$Moncontent->mamon}}"  class="form-control" /><br/>
        ...
        <b class="ten2x">File đề cương</b> 
          @if ($Moncontent->file)
            <a href="{{ asset($Moncontent->file) }}">Xem file</a> 
          @else
            Chưa upload
          @endif<br>
        <b class="ten2x">Đề cương chi tiết</b><input type="file" name="files"  class="form-control"/><br/>
          ...
          <div id="tab2">
             <b class="ten2x">Tên môn <span style="color: red">(*)</span></b><input type="text" name="ten_en" value="{{$Moncontent->ten_en}}" class="form-control" required/><br/>
