...
<p class="text-center dam">GIẢNG VIÊN TỰ ĐÁNH GIÁ</p>
...
<!--giảng dạy -->
	...
	<tr>
		...
		<td class="text-center">{{$pgd->diemdat}}</td>					
		</tr>
	@endforeach
...
<!--tiêu chí khác -->
	...
	<tr>
		...
		<td class="text-center">{{$pk->diemdat}}</td>					
		</tr>
	@endforeach
...
<!-- <p class="dam">II. Ý KIẾN CỦA TẬP THỂ ĐƠN VỊ VÀ LÃNH ĐẠO TRỰC TIẾP QUẢN LÝ VIÊN CHỨC</p>
...
<p class="dam">III. KẾT QUẢ ĐÁNH GIÁ PHÂN LOẠI CỦA CẤP CÓ THẨM QUYỀN</p>
