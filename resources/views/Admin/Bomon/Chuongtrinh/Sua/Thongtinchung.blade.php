...
{{-- <form  method="post" action="set_bomon/chuong-trinh/cap-nhat-chuong-trinh/thong-tin-chung/{{$Chuongtrinh->id}}.html" enctype="multipart/form-data"> --}}
...
<div class="row" style="margin-top:20px;">
 ...
 <div class="row" style="margin:20px 0;">      
    ...
    <a href="{{ asset('set_bomon/chuong-trinh/list') }}"><input type="button" class="btn btn-danger" value="Thoát"></a>
