 ...
 <script type="text/javascript">
       $(document).ready(function() {
            ...
            $("#xoahet").click(function(){
                ...
                if (hoi==true) document.location.href = "set_bomon/chuong-trinh/multi_delete/" + listid;
            });
      });
</script>
...
<div class="h3 padding20 text-center">Danh sách Chương trình đào tạo</div>
    <div class="box">   
                                  ...
                                  @foreach($Chuongtrinh as $CT)                                  
                                      <tr>
                                              ...
                                              <td>
                                                ...
                                                <a class="btn btn-link btn-warning" href="{{ asset('set_bomon/chuong-trinh/cap-nhat-chuong-trinh/thong-tin-chung/'.$CT->id.'/1.html') }}">
                                                ...
                                                <td class="text-center"><img src="{{ asset('ht96_image/chuongtrinh/'.$CT->hinhanh) }}" style="width:80px; height:50px;"></td>           
                                        </tr>  
                                        @endforeach                          
                                    </tbody> 
                            </table>  
            ...
            {{-- <a href="set_bomon/chuong-trinh/them-chuong-trinh/thong-tin-chung/1.html"><button class=" btn btn-success btn2">Thêm</button></a>
