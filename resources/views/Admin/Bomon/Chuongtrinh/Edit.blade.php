...
<form name="" method="post" action="{{ asset('set_bomon/chuongtrinh/edit/'.$Chuongtrinh->id) }}" enctype="multipart/form-data">
  ...
  <div class="row" style="margin:20px 0;">      
        ...
        <div id="content_tabs">               
           ...
           <a href="set_bomon/chuongtrinh/list"><input type="button" value="Thoát"  class="btn btn-danger btn2" /></a> 
        </div>
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    $(document).on('change', '#bomon', function(){
        ...
        $.get("set_bomon/ajax/loadbomonedit/"+id_bomon+"/"+id_batdaotao,function(data){
            $('#mon').html(data);
        });      
    });
    ...
    $(document).on('change', '#batdaotao', function(){
        ...
        $.get("set_bomon/ajax/loadmonedit/"+id_batdaotao,function(data){
            $('#mon').html(data);
        });       
    });
    ...
    $(document).on('click', '.xoamon', function(){
         ...
         var id_chuongtrinh=<?=$Chuongtrinh->id?>;
          $.ajax({
                ...
                url: "set_bomon/ajax/xoamon/"+id_mon+"/"+id_chuongtrinh,
                type: 'GET',
                dataType: 'html', 
    ...
    $(document).on('click', '.themmon', function(){ 
        ...
        $.ajax({
                ...
                url: "set_bomon/ajax/themmon/"+id_mon+"/"+id_chuongtrinh,
                type: 'GET',
                dataType: 'html',  
                success: function(data){                      
                         $('#monht').html(data);
    ...
    $(document).on('click', '.themtohop', function(){ 
        ...
        $.ajax({
                ...
                url: "set_bomon/ajax/themtohop/"+id_tohop+"/"+diem+"/"+id_chuongtrinh,
                type: 'GET',
                dataType: 'html',  
                success: function(data){                      
                         $('#tohopht').html(data);
     ...
     $(document).on('click', '.xoatohop', function(){ 
        ...
        $.ajax({
                ...
                url: "set_bomon/ajax/xoatohop/"+id_tohop+"/"+id_chuongtrinh,
                type: 'GET',
                dataType: 'html',  
                success: function(data){                      
                         $('#tohopht').html(data);
     ...
     $(document).on('keyup','.edittohop',function(){
        ...
        $.ajax({
                ...
                url: "set_bomon/ajax/edittohop/"+id_tohop+"/"+id_chuongtrinh+"/"+diem,
                type: 'GET',
                dataType: 'html',  
                success: function(data){                      
                         // $('#tohopht').html(data);
