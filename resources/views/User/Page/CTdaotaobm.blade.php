		...
		<div class="container">
			<div class="row">
							...
							@foreach($Mon2 as $Mo)
								...
								<div id="pannelmon{{$Mo->id}}" class="pannelx">
									<div class="tienquyet">
										...
										<h3 class="bold" style="font-size:16px;">{{trans('Chuongtrinh.lythuyet')}}:&nbsp;&nbsp;{{$Mo->lt}}&nbsp;{{trans('Chuongtrinh.tiet')}}</h3>
										<h3 class="bold" style="font-size:16px;">{{trans('Chuongtrinh.thuchanh')}}:&nbsp;&nbsp;{{$Mo->th}}&nbsp;{{trans('Chuongtrinh.tiet')}}</h3>
										@if ($Mo->file)
				...
				<div class="col-lg-4 col-md-3 col-sm-3 col-xs-12 box-right">
					<section class="box1">
						<h3 class="tieude">{{trans('Chuongtrinh.chuongtrinhbm')}}</h3>
						@foreach($Chuongtrinhlq as $CTLQ)
							<div class="chuongtrinhlq bold">
							<a href="{{trans('Link.bomon')}}/<?php $tenkhongdau='tenkhongdau_'.$lang;echo $Bomon->$tenkhongdau; ?>/{{$Bomon->id}}/<?php $tenkhongdau='tenkhongdau_'.$lang;echo $CTLQ->$tenkhongdau; ?>/{{$CTLQ->id}}.html"><span class="fa fa-sign-in"></span>&nbsp;&nbsp;<?php $ten='ten_'.$lang;echo $CTLQ->$ten; ?></a>
							</div>
						@endforeach
					</section>
				</div>
