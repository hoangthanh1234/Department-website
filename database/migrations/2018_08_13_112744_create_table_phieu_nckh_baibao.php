...
class CreateTablePhieuNckhBaibao extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ht96_phieu_nckh_baibao', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('id_phieu')->usigned();
            $table->integer('id_tieuchi')->usigned();
            $table->integer('id_chitietbaibao')->usigned();
    ...
    {
        Schema::dropIfExists('ht96_phieu_nckh_baibao');
    }
}
