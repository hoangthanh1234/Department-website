...
class CreateTableTieuchiNckhDetai extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ht96_tieuchi_nckh_detai', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ht96_tieuchi_nckh_detai');
    }
}
